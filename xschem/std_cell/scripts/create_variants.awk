...
gf180mcu_dir = "/home/ethan/openmpw/pdk_1/gf180mcuC/libs.ref/gf180mcu_fd_sc_mcu7t5v0"
  xschem_dir="/home/ethan/openmpw/pdk_1/gf180mcuC/libs.tech/xschem/std_cells"
  
  pipe = "ls " gf180mcu_dir "spice/*/gf180mcu_fd_sc_mcu7t5v0*__*_*.spice|sort" 

  # /home/ethan/openmpw/pdk_1/gf180mcuC/libs.ref/gf180mcu_fd_sc_mcu7t5v0/gf180mcu_fd_sc_mcu7t5v0.spice

  while( pipe | getline line) {
    cell = line; sub(/^.*gf180mcu_fd_sc_mcu7t5v0__/,"", cell); sub(/\.spice$/, ".sym", cell)
