...
C {devices/vsource.sym} 490 30 0 0 {name=VIN2 value=3.3}
...
C {std_cells/nand2_1.sym} 580 -140 0 0 {name=x1 VDD=VDD VNW=VNW VPW=VPW VSS=VSS prefix=gf180mcu_fd_sc_mcu7t5v0__}
