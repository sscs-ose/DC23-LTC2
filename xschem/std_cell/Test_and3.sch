...
C {devices/vsource.sym} 760 -10 0 0 {name=VIN2 value=3.3}
...
C {std_cells/and3_1.sym} 850 -190 0 0 {name=x1 VDD=VDD VNW=VNW VPW=VPW prefix=gf180mcu_fd_sc_mcu7t5v0__ }
