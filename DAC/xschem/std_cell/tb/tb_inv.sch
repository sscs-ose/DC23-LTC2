...
C {std_cell/inv_1.sym} 560 -210 0 0 {name=x1 VDD=VDD VNW=VNW VPW=VPW VSS=VSS prefix=gf180mcu_fd_sc_mcu7t5v0__}
C {devices/code_shown.sym} -640 -275 0 0 {name=COMMANDS
only_toplevel=false
value="
...
"}
C {devices/code_shown.sym} -640 -470 0 0 {name=MODELS only_toplevel=true
