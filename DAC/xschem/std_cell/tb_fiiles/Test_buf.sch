...
C {devices/lab_pin.sym} 640 -150 0 1 {name=p4 sig_type=std_logic lab=vout}
...
C {std_cells/buf_1.sym} 560 -160 0 0 {name=x1 VDD=VDD VNW=VNW VPW=VPW VSS=VSS prefix=gf180mcu_fd_sc_mcu7t5v0__}
