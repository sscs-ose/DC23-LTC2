...
C {devices/vsource.sym} 490 -50 0 0 {name=VIN2 value=5}
C {devices/lab_pin.sym} 440 -20 0 1 {name=p1 sig_type=std_logic lab=0}
C {devices/lab_pin.sym} 490 -20 0 1 {name=p2 sig_type=std_logic lab=0}
...
"}
C {devices/vsource.sym} 210 -50 0 0 {name=VDD value=5}
...
C {and2_1.sym} 580 -140 0 0 {name=x1 VDD=VDD VNW=VNW VPW=VPW VSS=VSS prefix=gf180mcu_fd_sc_mcu7t5v0__}
