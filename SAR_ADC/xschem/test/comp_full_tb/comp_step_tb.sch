...
N 670 -450 720 -450 {
lab=outcomp}
C {devices/vsource.sym} 160 -300 0 0 {name=V1 value="PULSE(0 3 200n 100p 100p 10u 100u)"}
...
C {devices/lab_wire.sym} 540 -450 0 0 {name=p4 sig_type=std_logic lab=Vin1}
C {devices/lab_wire.sym} 540 -410 0 0 {name=p5 sig_type=std_logic lab=Vin2}
C {devices/lab_wire.sym} 540 -430 0 0 {name=p6 sig_type=std_logic lab=clk
}
