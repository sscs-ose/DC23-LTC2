...
plot clk \{Voutpreamp * 30\} \{vindiff * 1000\}
.endc"}
...
C {devices/vsource.sym} 10 -80 0 0 {name=V1 value="PULSE(-5000u 5000u 300n 100p 100p 1u 2u)"}
C {devices/vsource.sym} 90 -80 0 0 {name=V2 value=1.6}
C {devices/vsource.sym} 160 -80 0 0 {name=V3 value="PULSE(0 3 0 100p 100p 5n 10n)"}
