...
C {devices/vsource.sym} 850 270 0 0 {name=V2 value="sin(1.5 1.5 .2Meg)"}
...
C {devices/lab_pin.sym} 1010 370 0 0 {name=p5 sig_type=std_logic lab=nclk}
C {devices/lab_pin.sym} 1010 310 0 0 {name=p18 sig_type=std_logic lab=v}
C {symbols/pfet_03v3.sym} 1010 350 1 1 {name=M10
L=0.28u
W=5u
nf=1
m=1
