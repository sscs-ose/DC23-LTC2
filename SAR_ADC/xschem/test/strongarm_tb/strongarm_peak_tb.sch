...
N 810 -140 840 -140 {
lab=#net1}
C {devices/vsource.sym} 150 -140 0 0 {name=V1 value="PULSE(0 1 0 10p 10p 1n 15n)"}
...
C {strongarm.sym} 710 -70 0 0 {name=X1}
C {Vdiffmeter.sym} 940 -80 0 0 {name=X3}
C {Vdiffmeter.sym} 250 -310 0 0 {name=X2}
