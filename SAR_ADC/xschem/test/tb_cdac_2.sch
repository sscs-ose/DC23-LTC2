...
N 140 -120 170 -140 {
lab=out}
C {cdac_2.sym} -130 0 0 0 {name=x1 cu=5u}
...
C {devices/lab_pin.sym} 50 -140 0 0 {name=p3 sig_type=std_logic lab=vref}
...
C {inv.sym} 310 -180 1 0 {name=x3 cl=0.28u wp=0.44u wn=0.22u Wx=10u}
C {devices/gnd.sym} 270 -180 0 0 {name=l5 lab=GND}
C {devices/lab_pin.sym} 180 -240 0 0 {name=p18 sig_type=std_logic lab=sample}
