...
model=cap_mim_2f0fF
m=1}
C {devices/ipin.sym} 290 150 0 0 {name=p3 lab=vdd}
C {devices/ipin.sym} 310 180 1 1 {name=p4 lab=gnd}
C {devices/ipin.sym} 330 150 3 0 {name=p5 lab=sample
}
...
C {devices/ipin.sym} 50 100 0 0 {name=p9 lab=vref}
