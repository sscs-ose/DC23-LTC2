...
C {devices/vsource.sym} 50 -1070 0 0 {name=V5 value="PULSE(0 3.3 10n 100p 100p 10n 20n)"
}
C {devices/lab_wire.sym} 50 -1140 0 0 {name=p5 sig_type=std_logic lab=A
}
...
C {devices/gnd.sym} 50 -1020 0 0 {name=l2 lab=GND
}
